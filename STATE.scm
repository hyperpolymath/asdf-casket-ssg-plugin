...
;; STATE.scm - Project state tracking for asdf-casket-ssg-plugin
;; Media-Type: application/vnd.state+scm

(define-state asdf-casket-ssg-plugin
  (metadata
    (version "0.1.0")
    (schema-version "1.0.0")
    (created "2026-01-30")
    (updated "2026-01-30")
    (project "asdf-casket-ssg-plugin")
    (repo "hyperpolymath/asdf-casket-ssg-plugin"))

  (project-context
    (name "asdf-casket-ssg-plugin")
